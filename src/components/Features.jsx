...
const Features = () => {
  const features = [
    ...
    {
      image: "images/holistic_learning.jpeg",
    ...
    {
      image: "/images/teacher_explaining_concetp_to_children.jpeg",
  ...
  return (
    <div className="py-10 bg-[#f3f4f6]">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 gap-4 px-4">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white shadow-lg rounded-lg p-6 text-center transform hover:scale-105 transition-transform"
            >
              <div className="relative w-full h-50 sm:h-70 md:h-80 lg:h-96 overflow-hidden rounded-lg mb-2">
                <img
                  src={feature.image}
                  alt={feature.title}
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold text-emerald-800 mb-1">
                {feature.title}
              </h3>
              <p className="text-emerald-800 text-sm sm:text-base md:text-lg">
                {feature.description}
              </p>
            </div>
          ))}
