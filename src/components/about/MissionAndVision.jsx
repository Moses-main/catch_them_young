  ...
  return (
    <section className="mission-vision flex flex-col lg:flex-row p-6 gap-6 bg-white shadow-lg rounded-lg">
      ...
      <div className="content lg:w-1/2 mt-4 w-full lg:pr-8 mb-4 lg:mb-0">
        <h2 className="md:text-3xl text-xl font-bold text-emerald-800 text-center mb-4">
          Mission & Vision
        </h2>
        ...
        <div className="vision-section mb-4">
          ...
          {showVision && (
            <p className="text-lg md:text-lg text-sm text-justify">
        ...
        <div className="core-values-section mb-4">
          ...
          {showCoreValues && (
            <ul className="list-disc pl-6 text-justify md:text-lg text-sm text-gray-700">
              <li>
