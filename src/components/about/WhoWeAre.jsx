const WhoWeAre = () => (
  <section className="who-we-are flex gap-5 flex-col lg:flex-row p-6 bg-white shadow-lg rounded-lg">
    ...
    <div className="content lg:w-1/2 w-full lg:pr-8 mb-4 lg:mb-0">
      <h2 className="md:text-3xl text-lg font-bold text-emerald-800 mb-4 mt-20">
        Who We Are
      </h2>
      <p className="md:text-lg text-sm text-justify  text-gray-700 mb-4">
      ...
      <p className="md:text-lg text-justify text-sm text-gray-700">
