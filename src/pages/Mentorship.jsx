      ...
      <section className="mb-10 border-b-2 border-emerald-200 shadow-lg p-6 rounded-lg bg-white">
        ...
        <div className="flex flex-col md:flex-row items-center space-x-0 md:space-x-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            <img
              src="/images/how-it-works.jpg" // Replace with your image URL
              alt="How it works"
              className="rounded-lg w-full md:w-96"
            />
          </div>
      ...
      <section className="mb-10 border-b-2 border-emerald-200 shadow-lg p-6 rounded-lg bg-white">
        ...
        <div className="flex flex-col md:flex-row items-center space-x-0 md:space-x-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            <img
              src="/images/mentee-benefits.jpg" // Replace with your image URL
              alt="Benefits"
              className="rounded-lg w-full md:w-96"
            />
          </div>
      ...
      <section className="mb-10 border-b-2 border-emerald-200 shadow-lg p-6 rounded-lg bg-white">
        ...
        <div className="flex flex-col md:flex-row items-center space-x-0 md:space-x-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            <img
              src="/images/get-started.jpg" // Replace with your image URL
              alt="Get Started"
              className="rounded-lg w-full md:w-96"
            />
          </div>
